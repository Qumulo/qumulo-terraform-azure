...
| <a name="input_azure_environment"></a> [azure\_environment](#input\_azure\_environment) | OPTIONAL: Azure cloud environment (`"public"` or `"usgovernment"`) for the qumulo, azurerm, and azapi providers. | `string` | `"public"` | no |
